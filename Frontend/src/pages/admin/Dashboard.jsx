...
const AdminDashboard = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-6 animate-slideInUp" style={{animationDelay: '0.4s'}}>
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Platform Growth 📈</h3>
            <div className="flex space-x-2">
              <button className="px-3 py-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg text-sm font-medium shadow-sm">Users</button>
              <button className="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm hover:bg-gray-200 transition-colors duration-300">Jobs</button>
              <button className="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm hover:bg-gray-200 transition-colors duration-300">Applications</button>
            </div>
          </div>
          <div className="h-64 flex items-center justify-center border-2 border-dashed border-purple-300 rounded-xl bg-gradient-to-br from-purple-50 to-blue-50">
            <div className="text-center">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-blue-500 rounded-full blur-xl opacity-30"></div>
                <LineChart className="relative w-16 h-16 text-purple-500 mx-auto mb-4 animate-float" />
              </div>
              <p className="text-purple-600 font-semibold mb-2">Chart visualization would go here</p>
              <p className="text-sm text-purple-400">Integration with charting library needed</p>
            </div>
          </div>
        </div>

        {/* Recent Activities */}
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-6 animate-slideInUp" style={{animationDelay: '0.5s'}}>
          <div className="flex items-center justify-between mb-6">
      ...
      {/* Quick Actions */}
      <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-6 animate-slideInUp" style={{animationDelay: '0.6s'}}>
        <h3 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent mb-6">Quick Actions ⚡</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <button className="group p-6 border-2 border-gray-200 rounded-xl hover:border-purple-300 bg-gradient-to-br from-white to-gray-50 hover:from-purple-50 hover:to-blue-50 text-left transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mb-4 shadow-lg transform group-hover:scale-110 transition-transform duration-300">
              <Users className="w-6 h-6 text-white" />
            </div>
            <h4 className="font-bold text-gray-900 group-hover:text-purple-600 transition-colors duration-300">Manage Users</h4>
            <p className="text-sm text-gray-500 mt-1">View and manage user accounts</p>
          </button>
          <button className="group p-6 border-2 border-gray-200 rounded-xl hover:border-purple-300 bg-gradient-to-br from-white to-gray-50 hover:from-purple-50 hover:to-blue-50 text-left transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg">
            <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center mb-4 shadow-lg transform group-hover:scale-110 transition-transform duration-300">
              <Building className="w-6 h-6 text-white" />
            </div>
            <h4 className="font-bold text-gray-900 group-hover:text-purple-600 transition-colors duration-300">Manage Recruiters</h4>
            <p className="text-sm text-gray-500 mt-1">Approve and manage recruiters</p>
          </button>
          <button className="group p-6 border-2 border-gray-200 rounded-xl hover:border-purple-300 bg-gradient-to-br from-white to-gray-50 hover:from-purple-50 hover:to-blue-50 text-left transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg">
            <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center mb-4 shadow-lg transform group-hover:scale-110 transition-transform duration-300">
              <Activity className="w-6 h-6 text-white" />
            </div>
            <h4 className="font-bold text-gray-900 group-hover:text-purple-600 transition-colors duration-300">View Logs</h4>
            <p className="text-sm text-gray-500 mt-1">System logs and audit trail</p>
          </button>
          <button className="group p-6 border-2 border-gray-200 rounded-xl hover:border-purple-300 bg-gradient-to-br from-white to-gray-50 hover:from-purple-50 hover:to-blue-50 text-left transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg">
            <div className="w-12 h-12 bg-gradient-to-br from-red-500 to-pink-600 rounded-xl flex items-center justify-center mb-4 shadow-lg transform group-hover:scale-110 transition-transform duration-300">
              <Shield className="w-6 h-6 text-white" />
            </div>
            <h4 className="font-bold text-gray-900 group-hover:text-purple-600 transition-colors duration-300">Security Settings</h4>
            <p className="text-sm text-gray-500 mt-1">Configure security policies</p>
          </button>
        </div>
      </div>
    </div>
